    ...
    def create_adjacency_matrix(self):
        ...
        for vertex in self.vertices:
            for edge in vertex.edges:
                m[vertex.index][edge] = 1
                m[edge][vertex.index] = 1
        return m
...
def create_graph(data):
    ...
    edge_start = num_vertices + 2
    edge_count = int(lines[edge_start])
    for i in range(edge_count):
        from_index, to_index = map(int, lines[edge_start + 1 + i].split(","))
    ...
    start_index, target_color = lines[edge_start + edge_count + 1].split(",")
...
def main():
    ...
    target_color = create_graph(data)[2]
    # run dfs
    graph.dfs(start_index, target_color)
